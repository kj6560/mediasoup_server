...
$routes->add('conference_room', new Route(constant('URL_SUBFOLDER') . '/conference_room/{conf_id}/{user_id}', array('controller' => 'ConferenceController', 'method' => 'conference_room'), array('conf_id' => '[0-9]+', 'user_id' => '[0-9]+')));
//page routes
