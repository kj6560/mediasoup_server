...
if($auth->guard('user')){
    ...
    $routes->add('conferences', new Route(constant('URL_SUBFOLDER') . '/conference_detail/{conference_id}', array('controller' => 'ConferenceController', 'method'=>'conference_detail'), array()));
